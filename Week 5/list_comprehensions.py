...
almost_numbs_int = [int(almost_number) for almost_number in almost_numbers]
print(almost_numbs_int)

big_numbs = [almost_numbs_int for almost_numbs_int in almost_numbs_int if almost_numbs_int > 9]
print(big_numbs)